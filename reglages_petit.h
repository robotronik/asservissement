...
//PID lineique
#define KP_DELTA 1500//constante de proportionalité
#define KI_DELTA 0//composante d'intégration
#define KD_DELTA 80//composante de dérivation
//PID angulaire
#define KP_ALPHA 480//constante de proportionalité
...
#define MIN_VITESSE 160000 //vitesse minimale du robot pour qu'il commence à avancer
...
#define TICK_PAR_TOUR 80000 //nombre de ticks par tour complet du robot sur lui-même (tick/tour)
