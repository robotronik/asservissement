...
FICHIERS_C=asser.c PID.c communication.c hardware.c odometrie.c trajectoire.c debug/affichage.c math_precalc.c tests_unitaires.c ../robotronik.uart/text_reception.c reception.c match.c
...
match.o: match.c match.h debug/affichage.h
	$(CC) -o $@ -c $< $(CFLAGS)
